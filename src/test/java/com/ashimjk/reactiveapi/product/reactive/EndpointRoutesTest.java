...
@WebFluxTest({EndpointRoutes.class, ProductHandler.class})
class EndpointRoutesTest {
    ...
    void shouldGetProductById() {
        ...
        client.get()
              .uri("/routes/products/{id}", expectedProduct.getId())
              .accept(APPLICATION_JSON)
              .exchange()
              .expectStatus().isOk()
